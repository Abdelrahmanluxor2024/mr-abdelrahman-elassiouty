...
BEGIN
  ...
  (
    ...
    4,
    'python_basics',
    '["طباعة وعرض النصوص والنتائج على الشاشة", "قراءة مدخلات من المستخدم", "حفظ الكود في ملف", "إيقاف تشغيل البرنامج"]'::jsonb,
    'طباعة وعرض النصوص والنتائج على الشاشة',
  ...
  (
    ...
    4,
    'python_basics',
    '["student_age", "2nd_student", "student-name", "class"]'::jsonb,
    'student_age',
  ...
  (
    ...
    4,
    'python_basics',
    '["str (String)", "int (Integer)", "float (Float)", "bool (Boolean)"]'::jsonb,
    'str (String)',
  ...
  (
    ...
    4,
    'python_basics',
    '["باستخدام علامة الشباك #", "باستخدام علامتي //", "باستخدام <!-- -->", "باستخدام كلمة comment"]'::jsonb,
    'باستخدام علامة الشباك #',
